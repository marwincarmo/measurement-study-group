...
We are working on the final details of the group. It should be ready for everyone to join before Christmas.
If you are interested in participating in this community, please fill the registration form. We'll send an invitation to the group for every registered participant.

In the meanwhile, follow us on twitter to the latest updates (links below).
